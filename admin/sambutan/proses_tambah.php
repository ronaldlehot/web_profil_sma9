...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		if (file_exists('../../images/sambutan/' . $nama_foto)) unlink('../../images/infsambutanrmasi/' . $nama_foto);

		$query = mysqli_query($koneksi, "INSERT INTO tbl_sambutan ( isi, foto) VALUES( '$isi',  '$nama_foto')") or die(mysqli_error($koneksi));
