...
$id_pangkatgol = mysqli_escape_string($koneksi, $_POST['id_pangkatgol']);
...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		...
		$query = mysqli_query($koneksi, "INSERT INTO tbl_guru (nama, nip, jenis_kelamin, no_hp, tempat_lahir, tanggal_lahir, mata_pelajaran, alamat, foto, id_pangkatgol) VALUES('$nama', $nip, '$jenis_kelamin', '$no_hp', '$tempat_lahir', '$tanggal_lahir', '$mata_pelajaran', '$alamat', '$nama_foto', '$id_pangkatgol')") or die(mysqli_error($koneksi));
