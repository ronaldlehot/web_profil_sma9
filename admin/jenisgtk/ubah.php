					...
					<div class="card-body">
						<form method="POST" action="proses_ubah.php?id=<?= $row['id'] ?>">
							<div class="form-group">
								<label for="jenis_gtk">Kategori</label>
								<input type="text" class="form-control" id="jenis_gtk" placeholder="nama kategori" autocomplete="off" required="required" name="jenis_gtk" value="<?= $row['jenis_gtk'] ?>">
							</div>
							<div class="form-group">
