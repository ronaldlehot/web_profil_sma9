...
$id = $_GET['id'];
$query_kategori = mysqli_query($koneksi, "SELECT * FROM tbl_kategori_informasi");
$query_artikel = mysqli_query($koneksi, "SELECT * FROM tbl_informasi WHERE id = $id");
						...
						<form method="POST" action="proses_ubah.php?id=<?= $artikel['id'] ?>" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								*gambar sebelumnya <br>
								<img src="../../images/informasi/<?= $artikel['foto'] ?>" alt="<?= $row['judul'] ?>" width="500px" class="mt-2">
							</div>
							<div class="form-group">
