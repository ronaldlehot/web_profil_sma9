...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		if (file_exists('../../images/informasi/' . $nama_foto)) unlink('../../images/informasi/' . $nama_foto);

		$query = mysqli_query($koneksi, "INSERT INTO tbl_informasi (judul, isi, tanggal, foto, id_kategori) VALUES('$judul', '$isi', '$tanggal', '$nama_foto', $id_kategori)") or die(mysqli_error($koneksi));
