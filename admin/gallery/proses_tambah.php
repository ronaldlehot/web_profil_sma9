...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		if (file_exists('../../images/gallery/' . $nama_foto)) unlink('../../images/gallery/' . $nama_foto);

		$query = mysqli_query($koneksi, "INSERT INTO tbl_galeri (foto) VALUES( '$nama_foto' )") or die(mysqli_error($koneksi));
